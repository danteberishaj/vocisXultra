...
export const de: Dictionary = {
  meta: {
    title: "vocisXultra — Stimmen von jenseits",
    description:
      "Die Stiftung vocisXultra ist eine unabhängige gemeinnützige Kulturinstitution in Prishtina, der künstlerischen Exzellenz in der Vokalmusik gewidmet — Heimat des vocisXultra Vokalensembles.",
  },
  a11y: {
    ...
    rehearsalImageAlt:
      "Sängerinnen und Sänger in Alltagskleidung von hinten an Notenpulten in einem hellen Probenraum mit raumhohen Fenstern",
    scoreImageAlt:
  ...
  hero: {
    ...
    titleA: "Stimmen",
    titleB: "von jenseits.",
    est: "Gegründet 2026 · Prishtina, Kosovo",
    intro:
      "Eine unabhängige gemeinnützige Stiftung, der künstlerischen Exzellenz in der Vokalmusik verpflichtet — und der Überzeugung, dass die menschliche Stimme über das Gewöhnliche hinausträgt.",
    ctaEvents: "Kommende Konzerte",
    ctaEnsemble: "Das Ensemble kennenlernen",
    scrollHint: "Eintreten",
  },
  welcome: {
    heading: "Willkommen",
    body: [
  ...
  repertoire: {
    heading: "Repertoire",
    lede: "Sechs Jahrhunderte Vokalmusik — von der Polyphonie der Renaissance bis zu Werken aus diesem Jahr.",
    eras: [
      {
        period: "1400–1600",
        name: "Renaissance",
      ...
      },
      {
        period: "1750–1820",
        name: "Klassik",
        text: "Klarheit, Ausgewogenheit und Eleganz.",
      ...
      },
      {
        period: "1900–2000",
        name: "20. Jahrhundert",
        text: "Außergewöhnliche Vielfalt der musikalischen Sprache.",
    ...
    activities: [
      "Eigenständige Konzertproduktionen",
      "Festivalauftritte",
  ...
  footer: {
    meaning: "vocisXultra · Stimmen von jenseits",
