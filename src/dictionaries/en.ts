export const en = {
  meta: {
    title: "vocisXultra — Voices from Beyond",
    description:
      "The vocisXultra Foundation is an independent non-profit cultural institution in Prishtina dedicated to artistic excellence in vocal music — home of the vocisXultra Vocal Ensemble.",
  },
  a11y: {
    ...
    rehearsalImageAlt:
      "Singers in casual clothes seen from behind at music stands in a bright rehearsal room with floor-to-ceiling windows",
    scoreImageAlt:
  ...
  hero: {
    ...
    titleA: "Voices",
    titleB: "from beyond.",
    est: "Founded 2026 · Prishtina, Kosovo",
    intro:
      "An independent non-profit foundation devoted to artistic excellence in vocal music — and to the conviction that the human voice can carry further than the ordinary.",
    ctaEvents: "Upcoming performances",
    ctaEnsemble: "Meet the ensemble",
    scrollHint: "Enter",
  },
  welcome: {
    heading: "Welcome",
  ...
  repertoire: {
    heading: "Repertoire",
    lede: "Six centuries of vocal music — from renaissance polyphony to works written this year.",
    eras: [
      {
        period: "1400–1600",
        name: "Renaissance",
      ...
      },
      {
        period: "1750–1820",
        name: "Classical",
        text: "Clarity, balance and elegance.",
        composers: ["Mozart", "J. Haydn", "Beethoven", "M. Haydn"],
      },
      {
        period: "1820–1900",
        name: "Romantic",
        text: "The emotional and harmonic possibilities of the human voice, expanded.",
        composers: ["Mendelssohn", "Brahms", "Bruckner", "Fauré", "Stanford", "Rheinberger"],
      },
      {
        period: "1900–2000",
        name: "Twentieth Century",
        text: "Extraordinary diversity of musical language.",
  ...
  footer: {
    meaning: "vocisXultra · voices from beyond",
...
type DeepStringly<T> = {
  [K in keyof T]: T[K] extends string
    ...
    : T[K] extends readonly (infer U)[]
      ? readonly DeepStringly<U>[] extends readonly unknown[]
        ? readonly (U extends string ? string : DeepStringly<U>)[]
        : never
      : DeepStringly<T[K]>;
};

/** Structural type all locale dictionaries must satisfy. */
export type Dictionary = DeepStringly<typeof en>;
